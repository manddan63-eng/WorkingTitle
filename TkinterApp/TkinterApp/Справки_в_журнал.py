...
class App:
    ...
    def run_processing(self):
        ...
        try:
            ...
            change = self.process_files(startingTime)
            ...
            if not self.delayFile.get():
                ...
                if change==1:
                    updated_journal_path = self.journal.get()[:-5] +'_' + startingTime.strftime("%d-%m_%H-%M") +'.xlsx'
                else:
    ...
    def process_files(self, startT):
        ...
        # --- Сохранение в Excel ---
        output_path = journalPath[:-5] + '_'+ startT.strftime("%d-%m_%H-%M") +'.xlsx'
        ...
        self.log(f"\nБудет записано {len(Result)} строк в файл")
